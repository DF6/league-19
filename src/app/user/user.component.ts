...
export class UserComponent{
    ...
    public setEmblem(player) {
        ...
        if(this.appService.config.fieldLines.goalkeeper.find( (position) => { return this.appService.getPlayerById(player).position == position; }) != undefined && fieldMarkers.goalkeeper.length > 0) {
            this.http.post('./test_CMDataRequesting.php', {type: 'borEmb', player: fieldMarkers.goalkeeper[0]}).subscribe( () => {});
            ...
            this.http.post('./test_CMDataRequesting.php', {type: 'borEmb', player: fieldMarkers.defense[0]}).subscribe( () => {});
            ...
            this.http.post('./test_CMDataRequesting.php', {type: 'borEmb', player: fieldMarkers.midfield[0]}).subscribe( () => {});
            ...
            this.http.post('./test_CMDataRequesting.php', {type: 'borEmb', player: fieldMarkers.striker[0]}).subscribe( () => {});
        }
