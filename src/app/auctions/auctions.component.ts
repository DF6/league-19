...
export class AuctionsComponent implements OnInit{
    ...
    public raiseAuction(auctionID, index) {
        this.http.post('./CMDataRequesting.php', {type: 'pujSub', firstTeam: this.appService.getSigninById(auctionID).firstTeam, newTeam: this.appService.data.user.teamID, id: auctionID, amount: this.amountsRaised[index]}).subscribe( (response) => {
