<?php
  ...
  //session_start();
    ...
    while($row = mysqli_fetch_array($result)) {
      ...
      if($fecha_actual > $fecha_limite && (strcmp($tipo, "A") == 0 || strcmp($tipo, "L") == 0)) {
        ...
        if($resolver == true) {
            ...
            $consult3 = "UPDATE test_players SET team_id=" . $equipo . ", buyed_this_market=1 where id=" . $jugador;
    ...
    {
      $data = array();
      $query="INSERT INTO test_log (user, type, log_information) VALUES (0, 'CA', 'Subasta cerrada por " . $jugador . ": vendido al " . $equipo . " por " . $amount . "M€ (ID " . $id . ")";
